 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80*8, 80*8, 600.0*8/3, 102.073 }
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    43 // Z Clearance for Deploy/Stow
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (95)   // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (122.2)    // Y point for Z homing when homing all axes (G28).
#endif
